...
public class Temperature {
    ...
    public Temperature(Long id, String name, String status, GenderEnum sex, Integer age, Long idcard, Date idate, String place, String depart, Long phonenum, Date register) {
        this.id = id;
        this.name = name;
        this.status = status;
        this.sex = sex;
